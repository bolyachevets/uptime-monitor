...
const introComment = async () => `# This file was generated by bolyachevets/uptime-monitor@${await getUptimeMonitorVersion()}
#
# ===============================
...
jobs:
  release:
    ...
    steps:
      ...
      - name: Generate graphs
        uses: bolyachevets/uptime-monitor@${await getUptimeMonitorVersion()}
        with:
          command: "graphs"
        env:
